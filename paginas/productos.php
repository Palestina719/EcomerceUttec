...
<body>
	<div class="bienvenida1">
		<h2>Productos</h2>
		<center><a onclick="addProducto()"><img src="images/agregar.png"/></a></center>
	</div>

	<div id="Resultados">
		<?php
		include '../conexion.php';
		$cons="select id_producto,nombre,precio,descripcion,id_proveedor from productos";
		...
		<td id='JO'>Nombre:</td>
		<td id='JO'>Precio:</td>
		<td id='JO'>Descripcion:</td>
		<td id='JO'>ID Proveedor:</td>
